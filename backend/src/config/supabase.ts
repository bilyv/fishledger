...
export interface Database {
  public: {
    Tables: {
      ...
      // Contacts table - simplified customer/supplier management for messaging integration
      contacts: {
        Row: {
          contact_id: string;
          user_id: string;
      ...
      // User settings table - user preferences, messaging credentials, and application settings
      user_settings: {
        Row: {
          setting_id: string;
          user_id: string;
          ...
          email_port: number;
          use_tls: boolean;
          whapi_apikey: string | null;
          instance_id: string | null;
          whapi_phone_number: string | null;
