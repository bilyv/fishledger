          ...
          <CardContent className="px-6 pb-6">
            <Tabs value={loginType} onValueChange={(value) => setLoginType(value as "admin" | "worker")} className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6 h-10 bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                ...
                <TabsTrigger value="worker" className="h-8 text-xs font-medium rounded-md data-[state=active]:bg-white dark:data-[state=active]:bg-gray-600 data-[state=active]:shadow-sm data-[state=active]:text-gray-900 dark:data-[state=active]:text-white transition-all">
                  Worker
                </TabsTrigger>
              </TabsList>
